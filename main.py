...
label_font = font.Font(size=35, weight='bold',family='Monaco')
...
btn4['font'] = btn_font
btn4.grid(row=4, pady=(20,10), column=4)


btn6 = tk.Button(frame1, text='In Out', height=90, width=180, fg='green', command=in_out, image=btn6_image, compound='left')
btn6['font'] = btn_font
btn6.grid(row=5, pady=(20,50), column=1)

btn5 = tk.Button(frame1, height=90, width=180, fg='red', command=window.destroy, image=btn5_image)
btn5['font'] = btn_font
btn5.grid(row=5,pady=(20,50), column=3)
